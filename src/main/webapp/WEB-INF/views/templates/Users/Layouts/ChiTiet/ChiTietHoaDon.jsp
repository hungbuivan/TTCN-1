...
<%--            <td scope="col" style="color: black;font-weight: bold;font-size: 17px;background-color: #bac8f3;width: 200px">Hình thức</td>--%>
    ...
    <br>
    <!-- Form mới -->
    <div class="button" style="margin-bottom: 40px;margin-top: 20px;margin-left: 550px;margin-top: 30px">
        <div class="row">


            <div class="col-1">
                <button class="btn btn-primary" id="addButton" onclick="clickThem()" style="width: 130px;font-size: 15px;margin-top: 20px; margin-left: 20px";>
                    Hủy đơn hàng
                </button>
            </div>
            <div class="col-2"style="margin-left: 30px">
                ...
                <form method="post" action="/Admin/HoaDon/XacNhanHoaDonKhachHang">
                    ...
                    <button style="width: 130px;font-size: 15px;margin-top: 20px;margin-left:40px" formaction="/Admin/HoaDon/XacNhanHoaDonKhachHang" name="huy" value="${idHoaDonConvert}"
                            class="btn btn-primary">Xác nhận
                    </button>
                </form>
            </div>
			<div class="col-1" style="">
					<button class="btn btn-primary" id="exportPdfButton" style="width: 130px; font-size: 15px; margin-top: 20px" onclick="exportInvoiceToExcel()">
						   Xuất hóa đơn
					</button>
			</div>
