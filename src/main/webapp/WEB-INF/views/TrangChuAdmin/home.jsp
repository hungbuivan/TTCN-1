...
<div class="container" style="margin-bottom:350px">
    ...
    <div class="select_input" style="margin-top: 50px">
        ...
        <div class="row" style="margin-top: 30px">
            ...
            <div class="col-4">
                <h3 style="text-align: center">
                    <button disabled="" type="button" class="text-white bg-red-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
