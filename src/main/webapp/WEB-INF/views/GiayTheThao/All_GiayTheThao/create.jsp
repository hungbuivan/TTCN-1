            ...
            >
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <span style="color: red">*</span>
                        <input type="text" class="form-control" name="congDung" placeholder="Nhập công dụng" required>
                    </div>
					<div class="form-group col-md-4">
					    <label>Chất liệu</label>
                        <span style="color: red">*</span>
						<input type="text" class="form-control" name="chatLieu" placeholder="Nhập tên chất liệu" required>
						</div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <span style="color: red">*</span>
						<input type="text" class="form-control" name="dayGiay" placeholder="Nhập loại dây giày" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label >Trọng lượng</label>
                        <span style="color: red">*</span>
						<input type="text" class="form-control" name="trongLuong" placeholder="Nhập trọng lượng giày" required>
                    </div>
                    <div class="form-group col-md-4">
