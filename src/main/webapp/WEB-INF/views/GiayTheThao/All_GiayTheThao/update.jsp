        ...
        <form action="/GiayTheThao/update/${giayTheThao.id}" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <span style="color: red">*</span>
                    <input type="text" class="form-control" id="congDung" name="congDung" value="${giayTheThao.congDung}">
                </div>
                <div class="form-group col-md-4">
                    <label>Chất liệu </label>
                    <span style="color: red">*</span>
                    <input type="text" class="form-control" id="chatLieu" name="chatLieu" value="${giayTheThao.chatLieu}">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <span style="color: red">*</span>
					<input type="text" class="form-control" id="dayGiay" name="dayGiay" value="${giayTheThao.dayGiay}">
                </div>
                <div class="form-group col-md-4">
                    <label >Trọng lượng</label>
                    <span style="color: red">*</span>
                    <input type="text" class="form-control" id="trongLuong" name="trongLuong" value="${giayTheThao.trongLuong}">
                </div>
                <div class="form-group col-md-4">
                ...
                <c:forEach items="${giayTheThaoDetail}" var="giayTheThaoChiTiet" varStatus="i">
                    <tr>
                        ...
                        <th style="text-align: center">
							...
							<form action="/GiayTheThao/xoa-chi-tiet/${giayTheThaoChiTiet.giayTheThao.id}/${giayTheThaoChiTiet.id}" 
							method="post" 
							style="display: inline;">
							     <button type="submit" 
							     	class="btn btn-danger" 
							     	onclick="return confirm('Bạn có chắc chắn muốn xóa chi tiết này không?');">
							          	 Xóa
							      </button>
							</form>
