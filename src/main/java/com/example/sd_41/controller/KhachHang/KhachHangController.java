 ...
 // Todo code edit khách hàng
    ...
    public String edit(@PathVariable UUID id, Model model) {
        ...
        if (khachHang == null) {
            ...
            model.addAttribute("messageFind", "Không tìm thấy khách hàng với id: " + id);
            return "redirect:/KhachHang/list"; // Chuyển hướng về danh sách khách hàng
        }

        // Truyền đối tượng khách hàng vào model để hiển thị trong form
        model.addAttribute("khachHang", khachHang);
        return "/KhachHang/edit"; // Trả về trang edit
    }

    
    @RequestMapping(value = "/KhachHang/edit/{id}", method = RequestMethod.POST)
    public String update(@PathVariable UUID id, @ModelAttribute("khachHang") KhachHang khachHang, Model model) {
        ...
        existingKhachHang.setGhiChu(khachHang.getGhiChu());
    ...
    @Transactional
    @RequestMapping(value = "/KhachHang/delete/{id}", method = RequestMethod.POST)
    public String delete(@PathVariable UUID id, Model model) {
        ...
        // Xóa tất cả các giỏ hàng liên quan đến khách hàng
        gioHangRepository.deleteByKhachHang_Id(id);
